...
- **Bloqueios Ativos:** Nenhum no core da v1. Bloqueio anterior do módulo TSE 2026 superado com a ingestão dos dumps oficiais via `scripts/tse/fetch_candidaturas.py` (ver [docs/auditoria-dados-tse-2026.md](../docs/auditoria-dados-tse-2026.md)).
