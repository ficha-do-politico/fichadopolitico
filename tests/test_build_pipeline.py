...
class TestBuildPipeline(unittest.TestCase):
    ...
    def test_pipeline_output_files_exist_and_match(self):
        ...
        with open(SITE_TEMAS_FILE, encoding="utf-8") as f:
        ...
        self.assertEqual(
            camara_deps, site_deps, "Dataset de site/src/data difere de dados/camara/deputados.json"
        )
        ...
        self.assertEqual(
            senado_sens,
            site_sens,
            "Dataset de site/src/data/senadores.json difere de dados/senado/senadores.json",
        )
        ...
        self.assertEqual(
            site_temas, catalogo_temas, "site/src/data/temas.json difere do catálogo oficial"
        )
